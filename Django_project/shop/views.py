...
from shop.forms import UserRegister
from .models import Game, Buyer


# Create your views here.

def class_shop(request):
    title_class_shop = 'Магазин'
    context = {
        'title_class_template': title_class_shop
    }
    return render(request, 'class_shop.html', context=context)
